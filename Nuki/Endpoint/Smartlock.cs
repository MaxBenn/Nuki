...
namespace Nuki.Endpoint
{
    public static class Smartlock
    {
        ...
        /// <returns></returns>
        public static async Task<Model.Smartlock> PutSmartlockAsync(Model.Smartlock smartlock, string authUuid,
            string authSecret)
        {
        ...
        /// <returns></returns>
        public static async Task<Model.Smartlock> PutSmartlockAsync(int smartlockId, int type, string name,
        ...
        /// <returns></returns>
        public static async Task<HttpStatusCode> PostSmartlockActionAsync(Model.Smartlock smartlock,
            SmartlockAction action, SmartlockOption option)
        {
            var allInputParams = new List<KeyValuePair<string, string>>
            {
            ...
            var response = await WebApi.Client.PostAsJsonAsync($"smartlock/{smartlock.SmartlockId}/action", requestParams);
            return response.StatusCode;
        }
        ...
        public static async Task<HttpStatusCode> PostSmartlockActionLockAsync(Model.Smartlock smartlock)
        {
            ...
            var response =
                await WebApi.Client.PostAsync($"smartlock/{smartlock.SmartlockId}/action/lock", requestParams);
            return response.StatusCode;
        }
        ...
        public static async Task<HttpStatusCode> PostSmartlockActionUnlockAsync(Model.Smartlock smartlock)
        {
            ...
            var response =
                await WebApi.Client.PostAsync($"smartlock/{smartlock.SmartlockId}/action/unlock", requestParams);
            return response.StatusCode;
        }
        ...
        public static async Task<HttpStatusCode> PostSmartlockAdvancedConfigAsync(Model.Smartlock smartlock)
        {
            var allInputParams = new List<KeyValuePair<string, string>>();
            allInputParams.Add(
                new KeyValuePair<string, string>("lngTimeout", $"{smartlock.AdvancedConfig.LngTimeout}"));
            allInputParams.Add(new KeyValuePair<string, string>("singleButtonPressAction",
                $"{smartlock.AdvancedConfig.SingleButtonPressAction}"));
            allInputParams.Add(new KeyValuePair<string, string>("doubleButtonPressAction",
                $"{smartlock.AdvancedConfig.DoubleButtonPressAction}"));
            allInputParams.Add(new KeyValuePair<string, string>("automaticBatteryTypeDetection",
                $"{smartlock.AdvancedConfig.AutomaticBatteryTypeDetection}"));
            allInputParams.Add(new KeyValuePair<string, string>("unlatchDuration",
                $"{smartlock.AdvancedConfig.UnlatchDuration}"));
            allInputParams.Add(
                new KeyValuePair<string, string>("operationId", $"{smartlock.AdvancedConfig.OperationId}"));
            allInputParams.Add(
                new KeyValuePair<string, string>("totalDegrees", $"{smartlock.AdvancedConfig.TotalDegrees}"));
            allInputParams.Add(new KeyValuePair<string, string>("singleLockedPositionOffsetDegrees",
                $"{smartlock.AdvancedConfig.SingleLockedPositionOffsetDegrees}"));
            allInputParams.Add(new KeyValuePair<string, string>("unlockedToLockedTransitionOffsetDegrees",
                $"{smartlock.AdvancedConfig.UnlockedToLockedTransitionOffsetDegrees}"));
            allInputParams.Add(new KeyValuePair<string, string>("unlockedPositionOffsetDegrees",
                $"{smartlock.AdvancedConfig.UnlockedPositionOffsetDegrees}"));
            allInputParams.Add(new KeyValuePair<string, string>("lockedPositionOffsetDegrees",
                $"{smartlock.AdvancedConfig.LockedPositionOffsetDegrees}"));
            allInputParams.Add(new KeyValuePair<string, string>("detachedCylinder",
                $"{smartlock.AdvancedConfig.DetachedCylinder}"));
            allInputParams.Add(
                new KeyValuePair<string, string>("batteryType", $"{smartlock.AdvancedConfig.BatteryType}"));
            allInputParams.Add(new KeyValuePair<string, string>("autoLock", $"{smartlock.AdvancedConfig.AutoLock}"));
            allInputParams.Add(new KeyValuePair<string, string>("autoLockTimeout",
                $"{smartlock.AdvancedConfig.AutoLockTimeout}"));
            allInputParams.Add(new KeyValuePair<string, string>("autoUpdateEnabled",
                $"{smartlock.AdvancedConfig.AutoUpdateEnabled}"));
            var requestParams = new FormUrlEncodedContent(allInputParams);

            var response =
                await WebApi.Client.PostAsync($"smartlock/{smartlock.SmartlockId}/advanced/config", requestParams);
            return response.StatusCode;
        }
        ...
        public static async Task<HttpStatusCode> PostSmartlockAdvancedOpenerconfigAsync(Model.Smartlock smartlock)
        {
            var allInputParams = new List<KeyValuePair<string, string>>
            {
                ...
                new KeyValuePair<string, string>("shortCircuitDuration",
                    $"{smartlock.OpenerAdvancedConfig.ShortCircuitDuration}"),
                new KeyValuePair<string, string>("electricStrikeDelay",
                    $"{smartlock.OpenerAdvancedConfig.ElectricStrikeDelay}"),
                new KeyValuePair<string, string>("randomElectricStrikeDelay",
                    $"{smartlock.OpenerAdvancedConfig.RandomElectricStrikeDelay}"),
                new KeyValuePair<string, string>("electricStrikeDuration",
                    $"{smartlock.OpenerAdvancedConfig.ElectricStrikeDuration}"),
                new KeyValuePair<string, string>("disableRtoAfterRing",
                    $"{smartlock.OpenerAdvancedConfig.DisableRtoAfterRing}"),
                new KeyValuePair<string, string>("rtoTimeout", $"{smartlock.OpenerAdvancedConfig.RtoTimeout}"),
                new KeyValuePair<string, string>("doorbellSuppression",
                    $"{smartlock.OpenerAdvancedConfig.DoorbellSuppression}"),
                new KeyValuePair<string, string>("doorbellSuppressionDuration",
                    $"{smartlock.OpenerAdvancedConfig.DoorbellSuppressionDuration}"),
                ...
                new KeyValuePair<string, string>("soundConfirmation",
                    $"{smartlock.OpenerAdvancedConfig.SoundConfirmation}"),
                new KeyValuePair<string, string>("soundLevel", $"{smartlock.OpenerAdvancedConfig.SoundLevel}"),
                new KeyValuePair<string, string>("singleButtonPressAction",
                    $"{smartlock.OpenerAdvancedConfig.SingleButtonPressAction}"),
                new KeyValuePair<string, string>("doubleButtonPressAction",
                    $"{smartlock.OpenerAdvancedConfig.DoubleButtonPressAction}"),
                new KeyValuePair<string, string>("batteryType", $"{smartlock.OpenerAdvancedConfig.BatteryType}"),
                new KeyValuePair<string, string>("automaticBatteryTypeDetection",
                    $"{smartlock.OpenerAdvancedConfig.AutomaticBatteryTypeDetection}"),
                new KeyValuePair<string, string>("autoUpdateEnabled",
                    $"{smartlock.OpenerAdvancedConfig.AutoUpdateEnabled}"),
                new KeyValuePair<string, string>("operationId", $"{smartlock.OpenerAdvancedConfig.OperationId}")
            };

            var requestParams = new FormUrlEncodedContent(allInputParams);

            var response = await WebApi.Client.PostAsync($"smartlock/{smartlock.SmartlockId}/advanced/openerconfig",
                requestParams);
            return response.StatusCode;
        }
            ...
            string operationId = "")
        {
            ...
            var response =
                await WebApi.Client.PostAsync($"smartlock/{smartlockId}/advanced/openerconfig", requestParams);
            return response.StatusCode;
        }
        ...
        public static async Task<HttpStatusCode> PostSmartlockAdvancedSmartdoorconfigAsync(Model.Smartlock smartlock)
        {
            var allInputParams = new List<KeyValuePair<string, string>>
            {
                ...
                new KeyValuePair<string, string>("singleButtonPressAction",
                    $"{smartlock.SmartdoorAdvancedConfig.SingleButtonPressAction}"),
                new KeyValuePair<string, string>("doubleButtonPressAction",
                    $"{smartlock.SmartdoorAdvancedConfig.DoubleButtonPressAction}"),
                new KeyValuePair<string, string>("automaticBatteryTypeDetection",
                    $"{smartlock.SmartdoorAdvancedConfig.AutomaticBatteryTypeDetection}"),
                new KeyValuePair<string, string>("unlatchDuration",
                    $"{smartlock.SmartdoorAdvancedConfig.UnlatchDuration}"),
                ...
                new KeyValuePair<string, string>("supportedBatteryTypes",
                    $"{smartlock.SmartdoorAdvancedConfig.SupportedBatteryTypes}"),
                new KeyValuePair<string, string>("batteryType", $"{smartlock.SmartdoorAdvancedConfig.BatteryType}"),
                new KeyValuePair<string, string>("autoLockTimeout",
                    $"{smartlock.SmartdoorAdvancedConfig.AutoLockTimeout}"),
                new KeyValuePair<string, string>("autoLock", $"{smartlock.SmartdoorAdvancedConfig.AutoLock}")
            };
            var requestParams = new FormUrlEncodedContent(allInputParams);

            var response = await WebApi.Client.PostAsync($"smartlock/{smartlock.SmartlockId}/advanced/smartdoorconfig",
                requestParams);
            return response.StatusCode;
        }
            ...
            bool autoLock = true)
        {
            ...
            var response =
                await WebApi.Client.PostAsync($"smartlock/{smartlockId}/advanced/smartdoorconfig", requestParams);
            return response.StatusCode;
        }
        ...
        public static async Task<HttpStatusCode> PostSmartlockWebConfigAsync(Model.Smartlock smartlock)
        {
            var allInputParams = new List<KeyValuePair<string, string>>
            {
                new KeyValuePair<string, string>("batteryWarningPerMailEnabled",
                    $"{smartlock.WebConfig.BatteryWarningPerMailEnabled}"),
                new KeyValuePair<string, string>("dismissedLiftUpHandleWarning",
                    $"{smartlock.WebConfig.DismissedLiftUpHandleWarnings}")
            };
            var requestParams = new FormUrlEncodedContent(allInputParams);

            var response =
                await WebApi.Client.PostAsync($"smartlock/{smartlock.SmartlockId}/web/config", requestParams);
            return response.StatusCode;
        }
